...
class ImageHandler:
    ...
    async def process_image(
        ...
        prompt += (
            ...
            "`5-Attachments/` subfolder first (e.g. `5-Attachments/health/americo/` for health images, "
            "`5-Attachments/telegram/` for general photos, `5-Attachments/nanopower/{project}/` for work) "
